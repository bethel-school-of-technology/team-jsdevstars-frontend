...
function Articles() {
  return (
    <div className='articles-page'>
      ...
      <div className='main-container'>
        <Container>
          <img src="https://images.unsplash.com/photo-1607863680198-23d4b2565df0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTd8fGZpbmFuY2lhbHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60" alt="adults chatting" />
          <h3>Heading for fourth image</h3>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat excepturi dolorem atque pariatora iure nisi odio. Impedit omnis dolorum natus quasi! Ea voluptate voluptas labore voluptatibus dolorum magnam quidem explicabo culpa?</p>
        </Container>
      </div>
    </div>
